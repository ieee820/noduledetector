...
%train setin üzerinden cross-fold buraya ekle

\begin{figure}[tb]
\centering
\subfigure[]{\includegraphics[height=3.2cm]{figs/eval.png}\label{eval}}
\subfigure[]{\includegraphics[height=3.2cm]{figs/evalfeas.png}\label{evalfeas}}
